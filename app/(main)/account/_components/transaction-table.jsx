    ...
    <div className='space-y-4'> 
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        <div className='relative flex-1'>
            ...
            <Input
            placeholder="Search Transactions..." value={searchTerm} onChange={(e)=>setSearchTerm(e.target.value)} className='pl-8'/>
        </div>
        ...
        <Table>
            <TableHeader>
                <TableRow >
                    ...
                    <TableHead className="cursor-pointer" onClick={()=>handleSort("cateogry")}>
                ...
                filteredAndSortedTransactions.map((transaction)=>(
                    <TableRow key={transaction.id}>
                        ...
                        <TableCell>{transaction.isRecurring?(
                            <Tooltip>
                                <TooltipTrigger><Badge variant='outline' className='gap-1bg-puple-100 text-purple-700 hover:bg-purple-200'>
